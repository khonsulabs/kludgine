...
impl Color {
    pub const ALICEBLUE: Color = Color::new(240., 248. / 255., 1., 1.);
    pub const ANTIQUEWHITE: Color = Color::new(250., 235. / 255., 215. / 255., 1.);
    pub const AQUA: Color = Color::new(0., 1., 1., 1.);
    pub const AQUAMARINE: Color = Color::new(127. / 255., 1., 212. / 255., 1.);
    pub const AZURE: Color = Color::new(240., 1., 1., 1.);
    pub const BEIGE: Color = Color::new(245. / 255., 245. / 255., 220., 1.);
    ...
    pub const CADETBLUE: Color = Color::new(95. / 255., 158. / 255., 160., 1.);
    pub const CHARTREUSE: Color = Color::new(127. / 255., 1., 0., 1.);
    pub const CHOCOLATE: Color = Color::new(210., 105. / 255., 30., 1.);
    pub const CORAL: Color = Color::new(1., 127. / 255., 80., 1.);
    pub const CORNFLOWERBLUE: Color = Color::new(100., 149. / 255., 237. / 255., 1.);
    pub const CORNSILK: Color = Color::new(1., 248. / 255., 220., 1.);
    ...
    pub const DARKORANGE: Color = Color::new(1., 140., 0., 1.);
    pub const DARKORCHID: Color = Color::new(153. / 255., 50., 204. / 255., 1.);
    pub const DARKRED: Color = Color::new(139. / 255., 0., 0., 1.);
    pub const DARKSALMON: Color = Color::new(233. / 255., 150., 122. / 255., 1.);
    ...
    pub const DEEPPINK: Color = Color::new(1., 20., 147. / 255., 1.);
    ...
    pub const DODGERBLUE: Color = Color::new(30., 144. / 255., 1., 1.);
    pub const FIREBRICK: Color = Color::new(178. / 255., 34. / 255., 34. / 255., 1.);
    pub const FLORALWHITE: Color = Color::new(1., 250., 240., 1.);
    ...
    pub const HONEYDEW: Color = Color::new(240., 1., 240., 1.);
    pub const HOTPINK: Color = Color::new(1., 105. / 255., 180., 1.);
    pub const INDIANRED: Color = Color::new(205. / 255., 92. / 255., 92. / 255., 1.);
    pub const INDIGO: Color = Color::new(75. / 255., 0., 130., 1.);
    pub const IVORY: Color = Color::new(1., 1., 240., 1.);
    pub const KHAKI: Color = Color::new(240., 230., 140., 1.);
    pub const LAVENDER: Color = Color::new(230., 230., 250., 1.);
    pub const LAVENDERBLUSH: Color = Color::new(1., 240., 245. / 255., 1.);
    pub const LAWNGREEN: Color = Color::new(124. / 255., 252. / 255., 0., 1.);
    pub const LEMONCHIFFON: Color = Color::new(1., 250., 205. / 255., 1.);
    pub const LIGHTBLUE: Color = Color::new(173. / 255., 216. / 255., 230., 1.);
    pub const LIGHTCORAL: Color = Color::new(240., 128. / 255., 128. / 255., 1.);
    ...
    pub const LIGHTSALMON: Color = Color::new(1., 160., 122. / 255., 1.);
    pub const LIGHTSEAGREEN: Color = Color::new(32. / 255., 178. / 255., 170., 1.);
    pub const LIGHTSKYBLUE: Color = Color::new(135. / 255., 206. / 255., 250., 1.);
    ...
    pub const LIMEGREEN: Color = Color::new(50., 205. / 255., 50., 1.);
    ...
    pub const MEDIUMAQUAMARINE: Color = Color::new(102. / 255., 205. / 255., 170., 1.);
    ...
    pub const MEDIUMSEAGREEN: Color = Color::new(60., 179. / 255., 113. / 255., 1.);
    pub const MEDIUMSLATEBLUE: Color = Color::new(123. / 255., 104. / 255., 238. / 255., 1.);
    pub const MEDIUMSPRINGGREEN: Color = Color::new(0., 250., 154. / 255., 1.);
    ...
    pub const MINTCREAM: Color = Color::new(245. / 255., 1., 250., 1.);
    ...
    pub const OLDLACE: Color = Color::new(253. / 255., 245. / 255., 230., 1.);
    ...
    pub const PALEGOLDENROD: Color = Color::new(238. / 255., 232. / 255., 170., 1.);
    ...
    pub const PLUM: Color = Color::new(221. / 255., 160., 221. / 255., 1.);
    pub const POWDERBLUE: Color = Color::new(176. / 255., 224. / 255., 230., 1.);
    ...
    pub const SALMON: Color = Color::new(250., 128. / 255., 114. / 255., 1.);
    ...
    pub const SNOW: Color = Color::new(1., 250., 250., 1.);
    ...
    pub const VIOLET: Color = Color::new(238. / 255., 130., 238. / 255., 1.);
    ...
    pub const YELLOWGREEN: Color = Color::new(154. / 255., 205. / 255., 50., 1.);
}
