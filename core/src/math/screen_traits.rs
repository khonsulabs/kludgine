...
pub trait PixelAlignment {
    ...
    /// [`figures::num::Round::round()`], and converts back to
    /// [`Scaled`](super::Scaled) units.
    fn pixel_rounded(&self, scale: ScreenScale) -> Self;
    /// Converts `self` into [`Raw`](super::Raw) units, executes
    /// [`figures::num::Ceil::ceil()`], and converts back to
    /// [`Scaled`](super::Scaled) units.
    fn pixel_expanded(&self, scale: ScreenScale) -> Self;
    /// Converts `self` into [`Raw`](super::Raw) units, executes
    /// [`figures::num::Floor::floor()`], and converts back to
    /// [`Scaled`](super::Scaled) units.
...
where
    ...
    S: std::ops::Div<ScreenScale, Output = Self> + figures::Round + figures::Floor + figures::Ceil,
{
    fn pixel_rounded(&self, scale: ScreenScale) -> Self {
